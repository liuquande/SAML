...
To our knowledge, this is the first well-organized multi-site data for public use. The dataset can be used for research of Domain Generalization, Multi-site Learning and Life-long Learnging, etc.
